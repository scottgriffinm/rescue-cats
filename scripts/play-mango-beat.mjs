...
try {
  ...
  if (!modal.hero.includes("/assets/ui/star_buttercup.svg") && !modal.hero.includes("/assets/ui/star_primrose.svg") && !modal.hero.includes("/assets/ui/star_heather.svg") && !modal.hero.includes("/assets/ui/star_marigold.svg")) {
