...
try {
  ...
  if (!modal.hero.includes("/assets/ui/star_cosmos.svg") && !modal.hero.includes("/assets/ui/star_buttercup.svg") && !modal.hero.includes("/assets/ui/star_primrose.svg") && !modal.hero.includes("/assets/ui/star_heather.svg") && !modal.hero.includes("/assets/ui/star_marigold.svg")) {
  ...
  if (!save.bubbles.some((line) => line.includes("Come back tomorrow"))) {
