/**
 * Chapter 4 beat: L273 → Verbena@273 naming, then L274–L276.
 * Next friend must not unlock. L10 stays off-path. localStorage only.
 * L270 queues Pansy pending. Do not invent friend_092.
 */
...
const completedIds = [
  ...
  "L8",
  "L9",
  ...Array.from({ length: 262 }, (_, i) => `L${i + 11}`),
];
...
const SEED = {
  ...
  levelStrikes: {},
  seenCoach: true,
  bubbles: ["Pansy claimed the pansy saucer."],
...
try {
  ...
  await shot(page, "01_l273_before_verbena");
  await play(
    page,
    [
      ["black", "ArrowRight"],
  ...
  console.log("verbena naming", modal);
  if (modal.title !== "New friend!") throw new Error(`title ${modal.title}`);
  if (modal.input !== "") throw new Error(`Verbena prefilled ${modal.input}`);
  if (!modal.ctaDisabled) throw new Error("Welcome home should stay disabled");
  if (modal.line !== "Spike soft. Already claimed the verbena pot.") {
    throw new Error(`Verbena display line drifted: ${modal.line}`);
  }
  if (modal.chips.join(",") !== "Verbena,Spike,Pot") {
    throw new Error(`Verbena chips must be Verbena/Spike/Pot, got ${modal.chips.join("/")}`);
  }
  if (
    ...
    modal.chips.includes("Pansy") ||
    modal.chips.includes("Face") ||
    modal.chips.includes("Saucer") ||
    ...
    throw new Error("Verbena chips collided with  pools");
  }
  if (!modal.hero.includes("/assets/cats/verbena_loaf_72.svg")) {
    throw new Error(`Verbena hero missing spike loaf: ${modal.hero}`);
  }
  if (modal.hero.includes("/assets/cats/pansy_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Pansy loaf");
  }
  if (modal.hero.includes("/assets/cats/petunia_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Petunia loaf");
  }
  if (modal.hero.includes("/assets/cats/nasturtium_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Nasturtium loaf");
  }
  if (modal.hero.includes("/assets/cats/geranium_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Geranium loaf");
  }
  if (modal.hero.includes("/assets/cats/freesia_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Freesia loaf");
  }
  if (modal.hero.includes("/assets/cats/begonia_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Begonia loaf");
  }
  if (modal.hero.includes("/assets/cats/ranunculus_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Ranunculus loaf");
  }
  if (modal.hero.includes("/assets/cats/anemone_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Anemone loaf");
  }
  if (modal.hero.includes("/assets/cats/wisteria_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Wisteria loaf");
  }
  if (modal.hero.includes("/assets/cats/clematis_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Clematis loaf");
  }
  if (modal.hero.includes("/assets/cats/cosmos_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Cosmos loaf");
  }
  if (modal.hero.includes("/assets/cats/buttercup_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Buttercup loaf");
  }
  if (modal.hero.includes("/assets/cats/primrose_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Primrose loaf");
  }
  if (modal.hero.includes("/assets/cats/heather_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Heather loaf");
  }
  if (modal.hero.includes("/assets/cats/marigold_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Marigold loaf");
  }
  if (modal.hero.includes("/assets/cats/snapdragon_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Snapdragon loaf");
  }
  if (modal.hero.includes("/assets/cats/bluebell_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Bluebell loaf");
  }
  if (modal.hero.includes("/assets/cats/foxglove_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Foxglove loaf");
  }
  if (modal.hero.includes("/assets/cats/hyacinth_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Hyacinth loaf");
  }
  if (modal.hero.includes("/assets/cats/crocus_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Crocus loaf");
  }
  if (modal.hero.includes("/assets/cats/lily_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Lily loaf");
  }
  if (modal.hero.includes("/assets/cats/violet_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Violet loaf");
  }
  if (modal.hero.includes("/assets/cats/tulip_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Tulip loaf");
  }
  if (modal.hero.includes("/assets/cats/poppy_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Poppy loaf");
  }
  if (modal.hero.includes("/assets/cats/lotus_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Lotus loaf");
  }
  if (modal.hero.includes("/assets/cats/orchid_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Orchid loaf");
  }
  if (modal.hero.includes("/assets/cats/iris_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Iris loaf");
  }
  if (modal.hero.includes("/assets/cats/aster_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Aster loaf");
  }
  if (modal.hero.includes("/assets/cats/zinnia_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Zinnia loaf");
  }
  if (modal.hero.includes("/assets/cats/dahlia_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Dahlia loaf");
  }
  if (modal.hero.includes("/assets/cats/azalea_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Azalea loaf");
  }
  if (modal.hero.includes("/assets/cats/peony_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Peony loaf");
  }
  if (modal.hero.includes("/assets/cats/camellia_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Camellia loaf");
  }
  if (modal.hero.includes("/assets/cats/gardenia_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Gardenia loaf");
  }
  if (modal.hero.includes("/assets/cats/hibiscus_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Hibiscus loaf");
  }
  if (modal.hero.includes("/assets/cats/jasmine_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Jasmine loaf");
  }
  if (modal.hero.includes("/assets/cats/magnolia_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Magnolia loaf");
  }
  if (modal.hero.includes("/assets/cats/lavender_loaf_72.svg")) {
    throw new Error("Verbena hero must not use the Lavender loaf");
  }
  await shot(page, "02_verbena_naming");

  await page.click('[aria-label="Name suggestions"] button');
  await page.click('button[type="submit"]');
  await page.waitForFunction(
    () =>
      (document.body.innerText || "").includes("Verbena") &&
  ...
  if (!yard.save.friends.some((friend) => friend.friendId === "friend_091")) {
    throw new Error("Verbena was not named");
  }
  if (yard.save.friends.find((friend) => friend.friendId === "friend_091")?.name !== "Verbena") {
    throw new Error("Verbena name was not kept");
  }
  if (yard.save.friends.some((friend) => friend.friendId === "friend_092")) {
    throw new Error("friend_092 must not unlock");
  }
  if (
    !yard.imgs.includes("/assets/cats/verbena_loaf_72.svg") &&
    !yard.imgs.includes("/assets/cats/verbena_loaf_48.svg")
  ) {
    throw new Error(`yard missing Verbena spike loaf: ${yard.imgs.filter((src) => src?.includes("loaf")).join(",")}`);
  }
  if (!yard.text.includes("pot") && !yard.text.includes("Verbena")) {
    throw new Error("yard missing Verbena verbena pot line");
  }
  if (yard.phoneFrame) throw new Error("GameShell must stay full-viewport");
  await shot(page, "03_verbena_yard");

  await page.goto(`${BASE}/level/L274`, { waitUntil: "networkidle0" });
  await page.waitForFunction(() => document.body.innerText.includes("SPIKE CUT"));
  await play(
    page,
    [
      ["gray", "ArrowRight"],
  ...
  await shot(page, "04_l275_win");

  await page.goto(`${BASE}/level/L276`, { waitUntil: "networkidle0" });
  await page.waitForFunction(() => document.body.innerText.includes("TAPER STOP"));
  await play(
    page,
    [
      ["orange", "ArrowRight"],
  ...
  for (const id of ["L273", "L274", "L275", "L276"]) {
  ...
  if (after.save.friends.some((friend) => friend.friendId === "friend_092")) {
    throw new Error("friend_092 must not unlock this slice");
  }
  if (after.save.pendingUnlocks.some((pending) => pending.friendId === "friend_092")) {
    throw new Error("L276 clear must not queue the next friend");
  }
  if (after.text.includes("New friend!")) {
    throw new Error("L276 must not open a next-friend naming modal");
  }
  if (after.save.friends.filter((friend) => friend.friendId === "friend_091").length !== 1) {
    throw new Error("L276 must not unlock a Verbena duplicate");
  }
  if (!after.hud.includes("276") && !after.text.includes("276")) {
    throw new Error("Campaign HUD must show through 276 after L276 clear");
  }
  const paradeLocks = {
    friend_001: 3,
    friend_004: 12,
  ...
  console.log("CHAPTER 4 L273 + VERBENA + L274-276 OK");
} catch (error) {
  console.error("CHAPTER 4 VERBENA FAIL", error);
  try {
