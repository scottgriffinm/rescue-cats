/**
 * Search unique 6×6 LT02+LT08 boards for L298–L300.
 * Run: npx tsx scripts/gen-chapter4-coreopsis-levels.mjs
 */
...
const pack = {
  ...
  status: "SHIP READY",
  source: "Cleome Pass — L298–L300 need",
  chapter: 4,
  title: "Chapter 4 boards L298–L300",
  notes:
    "L298 Tick Cut / L299 Hoop Gap / L300 Sun Stop — habit-break vs Whisk Cut orange-first / Pod Gap gray-first / Spider Stop black-first; not Whisk/Pod/Spider/Plume/Comb/Flame/Floret/Bank/Spray/Disk/Tin/Disc; Tick Cut gray-first (not Whisk orange); Hoop Gap black-first (not Pod gray); Sun Stop orange-first (not Spider black); no WRAP/edge twin of Nori/Medlar; L300 occupancy off prior Stop twins and Nori (5,5).",
  levels: found.map((hit) => hit.level),
  teaches: {
    tick_cut_gray: "Gray first; orange cuts after the tick slide.",
    hoop_gap_black: "Black first then orange threads the hoop gap.",
    sun_stop_orange: "Orange first; black seats the sun.",
  },
  solver: {
...
writeFileSync(
  "data/levels/CHAPTER4_PUZZLE_L298_L300.json",
...
console.log("wrote L298–L300 JSON + /tmp/coreopsis-solves.json");
