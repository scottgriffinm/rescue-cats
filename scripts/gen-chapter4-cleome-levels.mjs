/**
 * Search unique 6×6 LT02+LT08 boards for L295–L297.
 * Run: npx tsx scripts/gen-chapter4-cleome-levels.mjs
 */
...
const pack = {
  ...
  status: "SHIP READY",
  source: "Celosia Pass — L295–L297 need",
  chapter: 4,
  title: "Chapter 4 boards L295–L297",
  notes:
    "L295 Whisk Cut / L296 Pod Gap / L297 Spider Stop — habit-break vs Plume Cut gray-first / Comb Gap black-first / Flame Stop orange-first; not Plume/Comb/Flame/Floret/Bank/Spray; Whisk Cut orange-first (not Plume gray); Pod Gap gray-first (not Comb black); Spider Stop black-first (not Flame orange); no WRAP/edge twin of Nori/Medlar; L297 occupancy off prior Stop twins and Nori (5,5).",
  levels: found.map((hit) => hit.level),
  teaches: {
    whisk_cut_orange: "Orange first; gray cuts after the whisk slide.",
    pod_gap_gray: "Gray first then orange threads the pod gap.",
    spider_stop_black: "Black first; orange seats the spider.",
  },
  solver: {
...
writeFileSync(
  "data/levels/CHAPTER4_PUZZLE_L295_L297.json",
...
console.log("wrote L295–L297 JSON + /tmp/cleome-solves.json");
