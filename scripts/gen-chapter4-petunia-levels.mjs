/**
 * Search unique 6×6 LT02+LT08 boards for L268–L270.
 * Run: npx tsx scripts/gen-chapter4-petunia-levels.mjs
 */
...
function makeLevel({ id, name, colors, walls, cats, gates, teach }) {
  return {
    id,
    name,
    width: 6,
