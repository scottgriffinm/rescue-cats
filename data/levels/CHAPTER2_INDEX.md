...
Campaign boards **L4, L5, L8, L9** (L1–L3 teach first). **L6–L7 are still authoring and are not loaded.** Ink unlocks at unique clear 6 (L8 in this sequence). Grid origin is top-left. Slides stop on **wall | cat | edge** only. Matching gates never brake. On LT08 boards, a **mismatch house is a solid**. **L10 is not on the Chapter 2 path.**
...
| L6–L7 | — | Still authoring. Not loaded. | — |
