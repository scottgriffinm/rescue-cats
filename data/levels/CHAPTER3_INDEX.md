...
| L50 | `CHAPTER3_PUZZLE_L49_L51.json` / `L50.json` | Latch Through — gray mismatch latches, then commit through | yes · mismatch solid |
| L51 | `CHAPTER3_PUZZLE_L49_L51.json` / `L51.json` | Offset Brake — orange/black houses offset; sequential brakes | yes · mismatch solid |
