...
| L43 | `CHAPTER3_PUZZLE_L43_L45.json` / `L43.json` | Thread West — thread past the gray solid (no Hold*) | yes · mismatch solid |
...
| L46 | `CHAPTER3_PUZZLE_L46_L48.json` / `L46.json` | Color Gap — color gap teach; not Hold East Close | yes · mismatch solid |
| L47 | `CHAPTER3_PUZZLE_L46_L48.json` / `L47.json` | Solid West — black house is the west brake | yes · mismatch solid |
| L48 | `CHAPTER3_PUZZLE_L46_L48.json` / `L48.json` | Clear Row — leave the house row, then the solid (not Vacate West) | yes · mismatch solid |
