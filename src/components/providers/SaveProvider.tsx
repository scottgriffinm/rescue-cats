                                                            ...
                                                            : catalog.friendId === "friend_091"
                                                              ...
                                                              : catalog.friendId === "friend_092"
                                                                ...
                                                                : catalog.friendId === "friend_093"
                                                                  ...
                                                                  : catalog.friendId === "friend_094"
                                                                    ? [`${instance.name} claimed the calendula tin.`]
                                                                    : catalog.friendId === "friend_095"
                                                                      ? [`${instance.name} claimed the lantana mound.`]
                                                                      : catalog.friendId === "friend_096"
                                                                        ? [`${instance.name} claimed the phlox bank.`]
                                                                        : catalog.friendId === "friend_097"
                                                                          ? [`${instance.name} claimed the celosia comb.`]
                                                                          : catalog.friendId === "friend_098"
                                                                            ? [`${instance.name} claimed the cleome pod.`]
                                                                            : catalog.friendId === "friend_099"
                                                                              ? [`${instance.name} claimed the coreopsis hoop.`]
                  : [];
        setSave({
          ...current,
          friends,
