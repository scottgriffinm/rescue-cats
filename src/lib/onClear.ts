...
/** Campaign hook — parade is keyed by level number (L12 → Tux, L15 → Ghost, L18 → Mist, L21 → Pepper, L24 → Pumpkin, L27 → Shadow, L30 → Noodle, L33 → Clover, L36 → Ash, L39 → Oak, L42 → Dumpling, L45 → Stripe, L48 → Cloud, L51 → Donna, L54 → Sunny, L57 → Nigel, L60 → Bean). */
