...
export function verifyChapter4Phlox(solves: Record<string, Array<[string, Dir]>>) {
  ...
  if (TUTORIAL_RESCUES.length !== 99) throw new Error("Met must include through Phlox (96) after Celosia (97)");
