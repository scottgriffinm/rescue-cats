...
export function verifyChapter4Tulip(solves: Record<string, Array<[string, Dir]>>) {
  ...
  if (TUTORIAL_RESCUES.length !== 82) throw new Error("Met must include through Tulip (68)");
  ...
  if (SLICE_UNLOCKS[207] !== "friend_069") throw new Error("SLICE_UNLOCKS[207] must be friend_069 after Violet ship");
