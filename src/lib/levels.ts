...
const HINTS: Record<string, string> = {
  ...
  L50: "Gray mismatch latches, then commit through. Color-step habits from L49 miss the latch.",
  L51: "Orange/black houses offset — sequential brakes. Latch-through habits from L50 miss the offset.",
};
