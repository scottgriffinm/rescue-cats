...
const HINTS: Record<string, string> = {
  ...
  L97: "Cress cut — cress the route onto orange; habit-break off Chive Cut.",
  L98: "Rue gap — rue black gap after the Fig beat.",
  L99: "Mint stop — orange/gray mint stops; not Hold*/Park*.",
};
