...
- **L50 Latch Through.** Gray mismatch latches, then you commit through (not L26 Thread East).
- **L51 Offset Brake.** Orange/black houses offset — sequential brakes (not Dual Cross / Dual Brake).
