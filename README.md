> **🚨 CEO HANDOFF:** read [`CEO_HANDOFF_CHECKPOINT.md`](./CEO_HANDOFF_CHECKPOINT.md) first — pick up from Nigel@57 (after Sunny@54).
...
# node scripts/play-chapter4-chervil.mjs
# node scripts/play-chapter4-lovage.mjs
# node scripts/play-chapter4-parsley.mjs
...
# node scripts/play-chapter4-lavender.mjs
# node scripts/play-chapter4-chamomile.mjs
# node scripts/play-chapter4-bergamot.mjs
# node scripts/play-chapter4-jasmine.mjs
# node scripts/play-chapter4-magnolia.mjs
# node scripts/play-chapter4-hibiscus.mjs
```
...
| `/level/L1` … `/level/L9`, `/level/L11` … `/level/L57` | Slide-budget boards (LT01 teach, LT02 collision, LT08 color, Ch.3 color-brake). L10 is off-path. |
